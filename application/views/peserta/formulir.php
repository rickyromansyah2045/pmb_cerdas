...
$(document).ready(function() {
	...
	$("#simpan").click(function(){
		...
		var IjTh		= $("#IjTh").val();
		// var IjJmlMP		= $("#IjJmlMP").val();
		var IjJmlNilai	= $("#IjJmlNilai").val();
		var KerjaAyah	= $("#KerjaAyah").val();
		var HasilAyah	= $("#HasilAyah").val();
		var PendAyah	= $("#PendAyah").val();
		var KerjaIbu	= $("#KerjaIbu").val();
		var HasilIbu	= $("#HasilIbu").val();
		var PendIbu		= $("#PendIbu").val();
		var NmWali		= $("#NmWali").val();
		var AlamatWali	= $("#AlamatWali").val();
		var HubWali		= $("#HubWali").val();
		...
		if(EMail.length==0){
			$('.bottom-right').notify({
				message: {text: 'Maaf, Email tidak boleh kosong'},type:'info'
			}).show();
			$("#EMail").focus();
			return false();
		}
		...
		if(GolDarah.length==0){
			$('.bottom-right').notify({
				message: {text: 'Maaf, Golongan Darah tidak boleh kosong'},type:'info'
			}).show();
			$("#GolDarah").focus();
			return false();
		}
		if(NmAsalSek.length==0){
			$('.bottom-right').notify({
				message: {text: 'Maaf, Nama Asal Sekolah tidak boleh kosong'},type:'info'
			}).show();
			$("#NmAsalSek").focus();
			return false();
		}
		if(NoIjazah.length==0){
			$('.bottom-right').notify({
				message: {text: 'Maaf, No Ijazah tidak boleh kosong'},type:'info'
			}).show();
			$("#NoIjazah").focus();
			return false();
		}
		if(IjTh.length==0){
			$('.bottom-right').notify({
				message: {text: 'Maaf, Tahun Ijazah tidak boleh kosong'},type:'info'
			}).show();
			$("#IjTh").focus();
			return false();
		}
		if(IjJmlNilai.length==0){
			$('.bottom-right').notify({
				message: {text: 'Maaf, Jumlah Nilai Ijazah tidak boleh kosong'},type:'info'
			}).show();
			$("#IjJmlNilai").focus();
			return false();
		}
		if(NmWali.length==0){
			$('.bottom-right').notify({
				message: {text: 'Maaf, Nama Wali tidak boleh kosong'},type:'info'
			}).show();
			$("#NmWali").focus();
			return false();
		}
		if(AlamatWali.length==0){
			$('.bottom-right').notify({
				message: {text: 'Maaf, Alamat Wali tidak boleh kosong'},type:'info'
			}).show();
			$("#AlamatWali").focus();
			return false();
		}
		if(HubWali.length==0){
			$('.bottom-right').notify({
				message: {text: 'Maaf, Hubungan Wali tidak boleh kosong'},type:'info'
			}).show();
			$("#HubWali").focus();
			return false();
		}
		// if(Jk.length==0){
		// 	$('.bottom-right').notify({
		// 		message: {text: 'Maaf, Jenis Kelamin tidak boleh kosong'},type:'info'
		// 	}).show();
		// 	$("#Jk").focus();
		// 	return false();
		// }
		// if(Wn.length==0){
		// 	$('.bottom-right').notify({
		// 		message: {text: 'Maaf, Warga Negara tidak boleh kosong'},type:'info'
		// 	}).show();
		// 	$("#Wn").focus();
		// 	return false();
		// }
		// if(KerjaAyah.length==0){
		// 	$('.bottom-right').notify({
		// 		message: {text: 'Maaf, Pekerjaan Ayah tidak boleh kosong'},type:'info'
		// 	}).show();
		// 	$("#KerjaAyah").focus();
		// 	return false();
		// }
		// if(HasilAyah.length==0){
		// 	$('.bottom-right').notify({
		// 		message: {text: 'Maaf, Penghasilan Ayah tidak boleh kosong'},type:'info'
		// 	}).show();
		// 	$("#HasilAyah").focus();
		// 	return false();
		// }
		// if(PendAyah.length==0){
		// 	$('.bottom-right').notify({
		// 		message: {text: 'Maaf, Pendidikan Ayah tidak boleh kosong'},type:'info'
		// 	}).show();
		// 	$("#PendAyah").focus();
		// 	return false();
		// }
		// if(KerjaIbu.length==0){
		// 	$('.bottom-right').notify({
		// 		message: {text: 'Maaf, Pekerjaan Ibu tidak boleh kosong'},type:'info'
		// 	}).show();
		// 	$("#KerjaIbu").focus();
		// 	return false();
		// }
		// if(HasilIbu.length==0){
		// 	$('.bottom-right').notify({
		// 		message: {text: 'Maaf, Penghasilan Ibu tidak boleh kosong'},type:'info'
		// 	}).show();
		// 	$("#HasilIbu").focus();
		// 	return false();
		// }
		// if(PendIbu.length==0){
		// 	$('.bottom-right').notify({
		// 		message: {text: 'Maaf, Pendidikan Ibu tidak boleh kosong'},type:'info'
		// 	}).show();
		// 	$("#PendIbu").focus();
		// 	return false();
		// }
...
<tr>
	<td>Jenis Kelamin</td>
	<td><input type="radio" name="JK" Value="L" checked> Laki-laki <input type="radio" name="JK" value="P" required> Perempuan</td>
</tr>
<tr>	
	<td>Alamat</td>
