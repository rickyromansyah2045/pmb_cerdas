...
<meta name="author" content="alfi dkk">
  ...
  <div class='notifications bottom-left'></div>
   ...
   <div class="row">
        <div class="alert alert-info" style="width:100%;">
        	<div class="container">
        	<div class="pull-left">
          <img src="<?php echo base_url();?>asset/images/ab.png" width="130" height="42" style="padding:7px;">
          </div>
...
<footer class="footer">
	...
	<div class="container">
          <div class="span12">
            <?php echo $this->config->item('credit_aplikasi');?> | Programmer : Alfi<br>
